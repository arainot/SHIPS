...
flux_K1_err = False
flux_K2_err = False
dmag_simplex_K1_mcmc = True
dmag_simplex_K2_mcmc = True
...
with open(julia_K2_path) as csvfile:
   ...
   for row in reader:
       ...
       julia_flux_K2[j,0] = float(row[5])
       julia_flux_K2[j,1] = float(row[6])
       ...
       julia_dmag_K2[j,0] = -2.5*mh.log10(julia_flux_K2[j,0]/27874094.331858)
